...
export class CheckoutComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // read the user email adress from browser Storage
    const theEmail = JSON.parse(this.storage.getItem('userEmail'));
    const firstName = JSON.parse(this.storage.getItem('Fname'));
    const lastName = JSON.parse(this.storage.getItem('Lname'));
